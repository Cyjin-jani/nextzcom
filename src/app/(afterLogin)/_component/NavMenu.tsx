...
const NavMenu = () => {
  ...
  // 같은 계층에 있는 페이지 레이아웃 주소(pathname?)까지 확인이 가능하다.
  // 예를 들면, compose까지만 되고, compose/tweet을 리턴하지는 않음. 1계층 (자식이 아닌 형제 관계만 가능)
  // 더 아래까지 알고 싶다면 useSelectedLayoutSegments라는 훅이 따로 있음 (리턴: ['compose', 'tweet'])
